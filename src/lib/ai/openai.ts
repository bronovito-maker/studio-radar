      ...
      input: [
        {
          ...
          content: [
            ...
            "Non assegnare punteggi numerici e non prendere decisioni commerciali al posto del CRM.",
      ...
      input: [
        {
          ...
          content: [
            ...
            "Interpreta le evidenze senza assegnare score, priorita o prossime azioni.",
