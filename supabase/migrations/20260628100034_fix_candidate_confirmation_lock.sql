-- Use an advisory lock so confirmation does not require UPDATE access to the shortlist table.
...
begin
  ...
  insert into public.leads (
    ...
    has_website, has_booking, estimated_value, source, google_place_id
  )
  values (
